...
// Visible to everyone — shows game instructions.
// Anonymous users land here and cannot go further.
// Logged-in users see a "Play Now" call to action.
          ...
          <Card className="h-100 border-warning">
            <Card.Body>
              ...
              <Card.Text>
                ...
                segment list and click them in order to build your route. Submit before
